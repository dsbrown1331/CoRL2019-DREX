...
if __name__=="__main__":
    ...
    demonstrations, learning_returns, learning_rewards, learning_gaze = gaze_utils.get_preprocessed_trajectories(env_name, dataset, data_dir, use_gaze, gaze_conv_layer)


    #TODO: change to use all demos
    #demonstrations = demonstrations[1:]
    #learning_returns = learning_returns[1:]
    ...
    print("demo lengths", [len(d) for d in demonstrations])
